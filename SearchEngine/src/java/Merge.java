...
public class Merge {
    ...
    public void inc_sort(ArrayList<Cell> p) {
        Comparator<Cell> xx = new Comparator<Cell>() {
           public int compare(Cell c1, Cell c2) {
               return c1.getDocId() - c2.getDocId();
           } 
        };
        
        Collections.sort(p, xx);
    }
